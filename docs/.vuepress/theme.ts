...
export default hopeTheme({
  ...
  copyright: '2019-2022 © Crawlab.cn All rights reserved',

  footer: '<div style="display: flex;align-items: center">\n' +
    '    <span style="margin-right:16px">渝ICP备2021011872号-1</span>\n' +
    '    <a style="display:flex;align-items:center;color:#383a42" target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=50011202503421"><img style="height:14px;margin-right:3px;font-size:12px" src="/assets/images/beian-logo.png">渝公网安备 50011202503421号</a>\n' +
    '  </div>',
  ...
  locales: {
    '/en': {
      ...
      navbar: navbar([
        ...
        {text: 'Official Site', icon: 'home', link: 'https://docs.crawlab.cn/en/'},
        {text: 'Demo', icon: 'slides', link: 'https://demo-pro.crawlab.cn'},
        {
          text: 'Older Versions',
          icon: 'tag',
          children: [
            {text: 'v0.5.x', link: 'https://docs-v05.crawlab.cn'},
          ],
        },
      ]),
    },
